package com.hw.opendds.tests.messenger.publisher;/*
 *
 *
...
public class TestPublisher {
    ...
    public static void main(String[] args) {
        ...
        //todo statusCondition由DDS自动创建，每个entity一个，当该entity的任何启用状态发生更改时，DDS将触发statusCondition
        StatusCondition sc = dw.get_statuscondition();
        //todo 设置只启用PUBLICATION_MATCHED_STATUS 状态
